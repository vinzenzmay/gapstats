...
execute_process(
  COMMAND "/home/vinzenz/dev/aln_qc/.pixi/envs/default/bin/git" --git-dir=.git show-ref "v2.4.1"
  WORKING_DIRECTORY "/home/vinzenz/dev/aln_qc/build-pixi/_deps/cli11-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/vinzenz/dev/aln_qc/build-pixi/_deps/cli11-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/vinzenz/dev/aln_qc/build-pixi/_deps/cli11-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
